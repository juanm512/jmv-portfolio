export const projects = [
  ...
  },
  {
    ...
    hero: { type: "image", src: "/multitenant-saas-base/hero.webp" },
    locales: {
      en: {
...

  {
    ...
    hero: { type: "image", src: "/typemachine/editor.webp" },
    locales: {
      en: {
        title: "TypeMachine",
        ...
        content: [
          ...
          { type: "grid", items: [ { src: "/typemachine/editor.webp", caption: "Editor view: the snippet, the mirror pane and the taskbar" } ] },
          ...
          { type: "grid", items: [ { src: "/typemachine/config.webp", caption: "Settings modal: each switch runs the real engine on an example" }, { src: "/typemachine/config-flexible.webp", caption: "Flexible spacing and punctuation rules" }, { src: "/typemachine/config-visual.webp", caption: "Visual comfort options" } ] },
          ...
          { type: "grid", items: [ { src: "/typemachine/historial.webp", caption: "Local history with ranking per key and bigram" }, { src: "/typemachine/replay.webp", caption: "Compressed replay of a session" } ] }
        ]
      },
      es: {
        title: "TypeMachine",
        ...
        content: [
          ...
          { type: "grid", items: [ { src: "/typemachine/editor.webp", caption: "Vista de editor: el snippet, el panel espejo y la barra de tareas" } ] },
          ...
          { type: "grid", items: [ { src: "/typemachine/config.webp", caption: "Modal de ajustes: cada switch corre el motor real sobre un ejemplo" }, { src: "/typemachine/config-flexible.webp", caption: "Reglas de espaciado y puntuación flexibles" }, { src: "/typemachine/config-visual.webp", caption: "Opciones de confort visual" } ] },
          ...
          { type: "grid", items: [ { src: "/typemachine/historial.webp", caption: "Historial local con ranking por tecla y bigrama" }, { src: "/typemachine/replay.webp", caption: "Replay comprimido de una sesión" } ] }
        ]
      }
    }
  },
