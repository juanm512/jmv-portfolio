...
/*
 * BgSqLab — heading + rows in a clean ~720px column; floating glowing squares
 * in the margins. variant: 1 small squares | 2 fake windows | 3 mixed + parallax.
 */
export default function BgSqLab({ projects, variant = 1, title, intro }) {
  return (
    <>
      {variant === 1 && <BgSquares variant={1} />}
      {variant === 2 && <BgSquares variant={2} maxWindows={10} />}
      {variant === 3 && <BgSquares variant={3} maxSquares={50} maxWindows={6} parallax={18} />}
