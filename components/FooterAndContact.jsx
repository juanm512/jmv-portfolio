        ...
        <div className="flex flex-col items-center justify-center px-5 mx-auto lg:w-11/12 lg:px-10 md:flex-row py-20 border-t border-gray-700">
          <div className="basis-full flex flex-col items-center justify-center lg:flex-grow md:flex md:flex-row md:justify-between gap-8 mx-auto">
            <div className="md:basis-1/3 text-gray-600 text-center">
              <p>© 2022 Juan Manuel Vila. All Rights Reserved.</p>
            </div>

            <div className="md:basis-1/3 text-gray-600 text-center">
              <p>512juanm@gmail.com</p>
            </div>
...
const ContactDesktop = () => {
  ...
  return (
    <div
      className="flex flex-col w-full show-on-scroll"
      id="Contact"
    >
      <div className="flex flex-col items-center justify-center px-5 mx-auto md:w-11/12 lg:px-10 md:flex-row py-20 border-t border-gray-700">
        <div className="basis-full flex items-center flex-row justify-center">
          <div
            className="relative flex justify-center items-center group cursor-pointer w-64 h-64 my-32 p-8 transition-color duration-[2s] hover:border-palette-400 border-gray-900 border-offset-[96px] "
            onMouseEnter={() => handleContactMe()}
            onMouseLeave={() => handleContactMeLeave()}
          ...
          >
              ...
              <button className="text-colored font-semibold ">
                {contactStatus === "copied" ? (
                  ...
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="w-full h-full text-palette-400  "
                  >
                    <path
                      strokeLinecap="round"
            ...
            <svg
              className="absolute top-0 left-0 w-full h-full scale-110 md:scale-150 transition-all duration-[1s] delay-150 group-hover:rotate-[360deg] group-hover:scale-150 md:group-hover:scale-[2.2] "
              viewBox="0 0 200 200"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center px-5 mx-auto md:w-11/12 lg:px-10 md:flex-row py-20 border-t border-gray-700">
        <div className="basis-full flex items-center flex-row justify-center">
          <motion.div
            className="relative flex justify-center items-center group w-64 h-64 my-32 p-8 "
            ...
            <div className="relative text-colored text-7xl font-normal md:text-7xl text-center">
              ...
              >
                <motion.svg
                  ...
                  whileTap={{
                    scale: 0.8,
                    transition: { duration: 0.06, delay: 0.05 }
                  }}
                >
                  <path
                    strokeLinecap="round"
