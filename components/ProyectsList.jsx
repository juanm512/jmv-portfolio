    ...
    return (
        ...
        viewport={{ once: true }}>
            ...
            <div className="basis-full flex flex-col items-center justify-center text-center lg:flex-grow md:flex md:flex-col md:justify-center">
                <h1 className="basis-full my-4 text-2xl font-normal text-gray-900 md:text-5xl border-b-2 border-palette-400">My Proyects</h1>
...
const ProyectCard = ({ proyect, index, activeID, setActiveID }) => {
    return(
    <motion.div layout key={index} className={"group overflow-hidden transition-opacity" + ( (activeID !== null && activeID === proyect.id) ? " md:col-span-3 opacity-100" : (" opacity-50 hover:opacity-100") )}>
        <motion.div onClick={() => setActiveID(proyect.id)} 
          className={" transition-all duration-500 transform cursor-pointer" + ( (activeID !== null && activeID === proyect.id) ? "grayscale-0" : (" grayscale group-hover:grayscale-0 ") )}
        ...
        <div className=" py-2">
          <button className="w-full flex justify-start " onClick={() => setActiveID(proyect.id)}> 
              <motion.h2 
...
const ProyectActive = ({ proyect, index, activeID, setActiveID }) => {
    ...
    return(
        <motion.div layout class=" md:col-span-3 opacity-100 flex flex-col w-full bg-white" id="ProyectActive">
                ...
                <div class="relative flex flex-col w-full items-center">
                  ...
                  <div class="grid w-full grid-cols-1 items-start gap-y-8 gap-x-6 sm:grid-cols-12 lg:gap-x-8 lg:py-10 sm:pt-8">
                    ...
                    <div class="col-span-12 lg:col-span-8 flex flex-col">
                      ...
                      <section aria-labelledby="information-heading" class="flex justify-start pt-5 pb-0 basis-full">
